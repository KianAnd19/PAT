 ...
 * @author Kian
 */
class Level3Screen extends javax.swing.JFrame implements Runnable
{
    ...
    public Level3Screen()
    {
        ...
        KeyListener listener = new Level3Screen.MyKeyListener();
    ...
    private void initComponents()
    {
        ...
        userMessage.setFont(new java.awt.Font("Consolas", 0, 36)); // NOI18N
        ...
        userMessage.setBounds(370, 30, 1160, 70);
        ...
        lblCurrency2.setText("Level 3:");
        getContentPane().add(lblCurrency2);
        lblCurrency2.setBounds(-180, 10, 560, 50);
        ...
        lblCurrency.setBounds(1640, 30, 240, 30);
        ...
        obstacleCollide3.setBounds(1940, 550, 60, 50);
        ...
        foreground.setBounds(0, 0, 1960, 1080);
        ...
        chest.setBounds(1370, 860, 140, 120);
        ...
        obstacle4.setBounds(1910, 500, 120, 140);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/anderson/Images/level3Background.PNG"))); // NOI18N
        getContentPane().add(background);
        background.setBounds(-10, -150, 5820, 1370);

        setSize(new java.awt.Dimension(1924, 1103));
        ...
        while (!gameClosed)
        {
            if (System.currentTimeMillis() - time > 3)
            {
                ...
                if (c.checkCollision(sprite, finish))
                {
                    ...
                    u.editTimes(0, 2, "" + (finishTime - startTime) / 1000);
                    
                    
                    userMessage.setText("Level 3 Complete");
                    currency += 100;
                    lblCurrency.setText("Currency: " + currency);
                    gameClosed = true;
                    new Level3Screen().dispose();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(Level3Screen.class
